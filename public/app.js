...
function boot() {
  ...
  function renderPanel(){
    ...
    if(tab==='office') panel.innerHTML=`<div class="intro-icon">◎</div><span class="panel-kicker">A VERY SMALL COMPANY</span><h3 class="panel-heading">Good questions.<br>Shared discoveries.</h3><p class="muted">An open office for six research agents. Follow their sources, sit in on a meeting, and watch ideas take shape.</p><div class="provider-note"><strong>${esc(!connected?'Server disconnected':'Hermes local worker')}</strong><p>${esc(!connected?'No live state available. Retrying every 5 seconds.':'Research cycles are generated by the connected local Hermes worker and synchronized with this office.')}</p></div><div class="section-rule"><span class="eyebrow">LATEST FIELD NOTES</span>${findings((state?.findings||[]).slice(0,2))}</div>`;
